                        ...
                        <div class="chat-left-aside">
                            <div class="people-list" id="people-list">
                                <ul class="list">
                                    <li class="clearfix">
                                        <div class="about">
                                            <a href="sd" class="name">Vincent Porter</a>
                                        </div>
                                    </li>
                                </ul>
                            </div>
    ...
    <div class="chatbox">
        <div class="chatbox-top">
            <div class="chatbox-avatar">
                <a href="javascript:;" class="hide-chat"><?= img('assets/images/user.png') ?></a>
            </div>
            <div class="chat-partner-name">
                <a href="javascript:;" class="hide-chat">Mamun Khandaker</a>
            </div>
            <div class="chatbox-icons">
                <a href="javascript:;" class="hide-chat"><i class="fa fa-minus"></i></a>
